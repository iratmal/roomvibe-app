        ...
        <div className="p-3 border-t border-rv-neutral space-y-2">
          {sidebarOpen && (
            <>
              ...
              <a
                href="#/studio"
                className="flex items-center gap-2 px-3 py-2 text-sm text-white bg-[#0B1F2A] hover:bg-[#071520] rounded-lg transition-colors"
              >
          ...
          <a
            href="#/studio"
            className={`flex items-center gap-2 px-3 py-2 text-sm text-white bg-[#0B1F2A] hover:bg-[#071520] rounded-lg transition-colors ${sidebarOpen ? 'hidden' : 'justify-center'}`}
            title="Open Studio"
          >
            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
              <path strokeLinecap="round" strokeLinejoin="round" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z" />
