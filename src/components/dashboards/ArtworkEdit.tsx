    ...
    <div className="min-h-screen bg-[#f7f8fa]">
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 pt-10 pb-16">
        ...
        <div className="p-8 bg-white rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-100">
          <h1 className="text-3xl font-semibold text-[#264C61] mb-2" style={{ fontFamily: 'Inter, sans-serif' }}>
            Edit Artwork
          </h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex gap-4 pt-4">
              <button
                type="submit"
                disabled={loading}
                className="flex-1 px-6 py-3.5 bg-[#264C61] text-white rounded-xl hover:bg-[#1D3A4A] transition-all font-semibold disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[#264C61]/25"
