      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        <div>
          ...
          <input
            ...
            className="w-full px-3 py-2.5 border border-slate-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#264C61] bg-white text-sm"
            required
          />
        </div>
        <div>
        ...
        <button
          type="submit"
          disabled={isLoading}
          className="w-full py-2.5 bg-[#264C61] text-white rounded-lg hover:bg-[#1D3A4A] transition-all font-semibold text-sm disabled:opacity-50"
        >
                ...
                >
                  ...
                  <div className="p-6">
                    <div className="flex items-start justify-between mb-3">
                      <h3 className="text-xl font-semibold text-[#264C61] group-hover:text-[#1D3A4A] transition-colors line-clamp-1" style={{ fontFamily: 'Inter, sans-serif' }}>
                        {collection.title}
                      </h3>
