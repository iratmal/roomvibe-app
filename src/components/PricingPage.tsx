...
const PLANS: PlanConfig[] = [
  {
    ...
    features: [
      '3 clean uploads + 7 RoomVibe-branded artworks',
  ...
  },
  {
    ...
    features: [
      ...
      'Share your exhibition with a public link',
      'Add a Buy button that links to your website, shop or contact page',
      'Download images for website and social media',
...
const FEATURE_ROWS: FeatureRow[] = [
  ...
  { feature: 'Virtual exhibitions', free: false, artist: '1 active', designer: false, gallery: 'Unlimited', artistPro: 'Unlimited' },
