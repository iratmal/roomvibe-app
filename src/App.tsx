...
function Studio() {
  ...
  useEffect(() => {
    ...
    if (import.meta.env.DEV) {
      console.log(
        `[Real-Scale] Room ${sceneId}: ${wallHeightCm}cm wall = ${wallPxHeight}px, ratio = ${ratio.toFixed(
          2
        )} px/cm`
      );
    }
  ...
  const handleDragMove = (e: MouseEvent | TouchEvent) => {
    ...
    // Calculate bounds: artwork (including frame) can move across entire wall
    const maxOffsetX =
      canvasWidth - padding - safeCenterX - totalWidthPxRef.current / 2;
    const minOffsetX =
      padding - safeCenterX + totalWidthPxRef.current / 2;
    const maxOffsetY =
      canvasHeight - padding - safeCenterY - totalHeightPxRef.current / 2;
    const minOffsetY =
      padding - safeCenterY + totalHeightPxRef.current / 2;
    ...
    <main>
      ...
      <div className="mx-auto max-w-[1400px] px-4 sm:px-6 lg:px-8 py-8">
        <div className="mb-4 text-sm text-slate-600">
          <span className="font-medium">RoomVibe Studio</span> · Upload a wall photo,
          pick a room preset, and see your art true-to-size.
        </div>
        <div className="grid grid-cols-12 gap-4 lg:gap-6">
          ...
          <section className="col-span-12 lg:col-span-6">
            <div className="rounded-2xl border border-slate-200 bg-white shadow-sm">
              ...
              <div
                ref={canvasRef}
                className="relative h-[560px] w-full overflow-hidden rounded-b-2xl"
              >
                {userPhoto ? (
                  <img
                    src={userPhoto}
              ...
              <div className="flex flex-wrap items-center gap-2">
                ...
                <input
                  ...
                  onChange={(e) => {
                    ...
                    const currentWidthCm =
                      sizeUnit === "cm" ? widthVal : widthVal * 2.54;
                    const currentHeightCm =
                      sizeUnit === "cm" ? heightVal : heightVal * 2.54;
            ...
            <div className="relative h-80 w-full">
              ...
              <div className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2">
                ...
                >
                  ...
                  selectedArtwork?.overlayImageUrl ? (
                    <img
                      src={
                        selectedArtwork.overlayImageUrl ||
                        selectedArtwork.imageUrl
    ...
    <Container>
      <div className="grid gap-10 lg:grid-cols-2 items-center">
        <div>
          ...
          <p className="mt-2 text-slate-600">
            RoomVibe turns your artwork into a visual experience. Show collectors
            exactly how a piece will feel in their space — before you ship it.
          </p>
        ...
        <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
          ...
          <h3 className="mt-3 text-lg font-semibold">
            “I can finally see if a piece truly fits my home.”
          </h3>
          <p className="mt-2 text-sm text-slate-600">
            Buyers can upload a photo of their living room, hallway or bedroom and
            instantly see how your work looks on their wall. No guessing, no
  ...
  return (
    <Container>
      <div className="mx-auto max-w-3xl text-center">
        ...
        <p className="mt-2 text-slate-600">
          One tool that works for original art, limited prints and high-end
          interior projects.
        </p>
      </div>
    ...
    <main>
      <Container>
        <div className="mx-auto max-w-3xl text-center">
          ...
          <p className="mt-2 text-slate-600">
            Add RoomVibe to your website with a simple script tag or React component. Copy
            the snippets below and publish.
          </p>
        </div>
      </Container>
      <DocsEmbed />
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="relative overflow-hidden rounded-3xl border border-slate-200 bg-[radial-gradient(1200px_500px_at_50%_0%,color-mix(in_oklab,var(--accent),white_85%),white)] p-8 sm:p-12">
          ...
          <div className="mx-auto mt-8 max-w-3xl text-sm text-slate-700">
            ...
            <p className="mt-1">
              Online Store → Themes → Edit code → add the container + UMD script in the
              desired template/section. For app-block integration, we’ll ship a block later.
            </p>
      ...
      <Container id="privacy">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="mt-6 grid gap-4 text-slate-700">
            <p>
              This short version applies to the RoomVibe widget/app, demo and embeds. For
              store cookies on Shopify, please refer to their Cookie Policy.
            </p>
            <p>
              Controller: Lumina Start j.d.o.o., Drašnička 6, 10000 Zagreb, Croatia ·
              info@irenart.studio
            </p>
            <p>
              What we collect: (i) contact/leads you submit, (ii) display preferences you
              choose, (iii) technical logs for security and performance. Payments are
              processed by Shopify/ThriveCart and Stripe/PayPal — RoomVibe does not store
              payment data.
            </p>
            <p>
              Your rights (GDPR): access, rectification, erasure, restriction, portability,
              objection; and you can withdraw consent where applicable.
            </p>
            <p>
              Cookies: we use essential cookies/localStorage for widget functionality;
              analytics/marketing only with consent. Shopify stores use Shopify’s cookie
              framework.{" "}
              <a
                className="text-slate-900 underline"
                href="https://www.shopify.com/legal/cookies"
